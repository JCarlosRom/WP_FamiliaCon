...
= 1.6 =
* New: Loading icon appears when waiting for new posts after clicking the "Cargar más..." button
...
* New: Added translation files for French (fr_FR), German (de_DE), English (en_EN), Spanish (es_ES), Italian (it_IT), and Russian (ru_RU) to translate "Cargar más..." and "Follow on Instagram"
