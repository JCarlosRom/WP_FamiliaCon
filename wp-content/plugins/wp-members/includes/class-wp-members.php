...
class WP_Members {
	...
	function get_text( $str ) {
		...
		$defaults = array(
			...
			// Login form.
			'login_heading'        => __( 'Ingresar', 'wp-members' ),
			'login_username'       => __( 'Usuario o Correo', 'wp-members' ),
			'login_password'       => __( 'Contraseña', 'wp-members' ),
			'login_button'         => __( 'Ingresar', 'wp-members' ),
			'remember_me'          => __( 'Recuerdame', 'wp-members' ),
			'forgot_link_before'   => __( '¿Olvidaste tu contraseña?', 'wp-members' ) . '&nbsp;',
			'forgot_link'          => __( 'Click aquí para reestablecer', 'wp-members' ),
			'register_link_before' => __( '¿Usuario nuevo?', 'wp-members' ) . '&nbsp;',
			'register_link'        => __( 'Click aquí para registrar', 'wp-members' ),
			
			// Password change form.
			'pwdchg_heading'       => __( 'Cambiar contraseña', 'wp-members' ),
			'pwdchg_password1'     => __( 'Nueva contraseña', 'wp-members' ),
			'pwdchg_password2'     => __( 'Confirmar nueva contraseña', 'wp-members' ),
			'pwdchg_button'        => __( 'Actualizar contraseña', 'wp-members' ),
			
			// Password reset form.
			'pwdreset_heading'     => __( 'Resetear contraseña olvidada', 'wp-members' ),
			'pwdreset_username'    => __( 'Nombre de usuario', 'wp-members' ),
			'pwdreset_email'       => __( 'Correo', 'wp-members' ),
			'pwdreset_button'      => __( 'Reestablecer contraseña' ),
			'username_link_before' => __( '¿Olvidaste la contraseña?', 'wp-members' ) . '&nbsp;',
			'username_link'        => __( 'Click aquí', 'wp-members' ),
			
			// Retrieve username form.
			'username_heading'     => __( 'Recuperar Nombre de Usuario', 'wp-members' ),
			'username_email'       => __( 'Correo electrónico', 'wp-members' ),
			'username_button'      => __( 'Recuperar Nombre de Usuario', 'wp-members' ),
			
			// Register form.
			'register_heading'     => __( 'Registro Nuevo Usuario', 'wp-members' ),
			'register_username'    => __( 'Escoja un Nombre de Usuario', 'wp-members' ),
			'register_rscaptcha'   => __( 'Ingresa el Código:', 'wp-members' ),
			'register_tos'         => __( 'Por favor indica que estás deacuerdo con nuestros términos y condiciones', 'wp-members' ), // @note: if default changes, default check after wpmem_tos_link_txt must change.
			'register_clear'       => __( 'Reestablecer formulario', 'wp-members' ),
			'register_submit'      => __( 'Registrar', 'wp-members' ),
			'register_req_mark'    => '<span class="req">*</span>',
			'register_required'    => '<span class="req">*</span>' . __( 'Required field', 'wp-members' ),
			
			// User profile update form.
			'profile_heading'      => __( 'Editar tu información', 'wp-members' ),
			'profile_username'     => __( 'Nombre de Usuario', 'wp-members' ),
			'profile_submit'       => __( 'Actualizar perfil', 'wp-members' ),
			'profile_upload'       => __( 'Actualizar este documento', 'wp-members' ),
			...
			// Default Dialogs.
			'restricted_msg'       => __( "Este contenido está limitado para miembros del sitio, si tienes un usuario existente, por favor ingresa. Nuevos usuarios deben registrarse debajo.", 'wp-members' ),
