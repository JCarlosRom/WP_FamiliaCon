...
class DDR_WP_REST_OAuth1 {
	...
	public function check_token( $token, $consumer_key ) {
		...
		$consumer = DDR_WP_REST_OAuth1_Client::get_by_key( $consumer_key );
	...
	public function generate_request_token( $params ) {
		$consumer = DDR_WP_REST_OAuth1_Client::get_by_key( $params['oauth_consumer_key'] );
		if ( is_wp_error( $consumer ) ) {
			return $consumer;
		}
